 ...
 *     		1) AngularJS (@see https://docs.angularjs.org/guide/templates)
 *     		2) TAL (@see http://en.wikipedia.org/wiki/Template_Attribute_Language)
 *			  3) CSS Parser (@example http://querypath.org/)
 *
 **/
